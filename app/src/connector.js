'use strict';
  ...
  var Billboard, Box, Fog, Skybox, Plane, Player, Model, Element,
	Color, Connector, EventEmitter, StyleMap, TWEEN, URI, Utils,
	...
	Model 		= require("./object/model");
	Element 	= require("./object/element");
  ...
  Connector = (function(_super) {
	...
	Connector.prototype.reconnect = function() { this.connect(); };
  ...
  Connector.prototype.createPlayer = function(el) {
    ...
    var faceTexture = new THREE.ImageUtils.loadTexture('/img/face.png');
